...
final class Version20260522210949 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bureau (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(150) NOT NULL, localisation VARCHAR(255) NOT NULL, heure_ouverture TIME NOT NULL, heure_fermeture TIME NOT NULL, actif TINYINT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE reception (id INT AUTO_INCREMENT NOT NULL, nom_site VARCHAR(150) NOT NULL, statut_service VARCHAR(50) NOT NULL, actif TINYINT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
